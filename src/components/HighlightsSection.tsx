    ...
    >
      ...
      <div className="flex justify-center mt-6 space-x-4">
        {visibleCount < items.length && (
          <button
            onClick={handleLoadMore}
            className="bg-transparent border font-mono border-green-500 text-green-500 hover:bg-green-500 hover:text-black shadow-md shadow-green-500/50 hover:shadow-lg hover:shadow-green-600/60 transition-all py-2 px-4 rounded flex items-center justify-center"
          >
            Load More...
          </button>
        )}
        {batchCount > 1 && (
          <button
            onClick={handleShowLess}
            className="font-mono bg-transparent border border-red-500 text-red-500 hover:bg-red-500 hover:text-black shadow-md shadow-red-500/50 hover:shadow-lg hover:shadow-red-600/60 transition-all py-2 px-4 rounded flex items-center justify-center"
          >
            Show Less...
          </button>
        )}
