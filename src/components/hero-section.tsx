...
export function HeroSection() {
  ...
  return (
    <div
      ref={ref}
      className="h-screen relative overflow-hidden bg-gradient-to-b from-background via-background/95 to-background/90"
    >
      ...
      <motion.div style={{ y, opacity }} className="absolute inset-0 h-full">
        <HeroContent />
      </motion.div>
